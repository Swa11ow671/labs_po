...
public class ImplementationArrow implements Arrow {
    @Override
    public void drawArrow(Paint paint, Canvas canvas, float[] pos) {
        ...
        float deltaX = x1 - x0; //xDiff
        float deltaY = y1 - y0; //yDiff
        double distance = sqrt((deltaX * deltaX) + (deltaY * deltaY)); // Length
